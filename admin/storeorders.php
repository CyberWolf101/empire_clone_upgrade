...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Walk-In Orders</h1>
  <ol class="breadcrumb">
...
<div class="col-xl-12 col-lg-12 mb-4">
  <div class="card">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Walk-In Orders</h6>
    </div>
    ...
    <div class="table-responsive">
      <table class="table align-items-center table-flush">
        ...
        <tbody>
          ...
          // Build SQL query
          $sql = "SELECT id, name, total_amount, status" . ($has_date ? ", date" : "") . " FROM saloon_orders WHERE section='refreshments' AND pay_status='paid' AND type='store'";
          $sql .= $has_date ? " ORDER BY date DESC" : " ORDER BY id DESC";
          $count_query = "SELECT COUNT(*) AS total_rows FROM saloon_orders WHERE section='refreshments' AND pay_status='paid' AND type='store'";
            ...
            <td>
              <div class='dropdown'>
                ...
                <div class='dropdown-menu' aria-labelledby='dropdownMenu_$id'>
                  ...
                  <a class='dropdown-item' href='foodreciept.php?order=" . $id . "'>Print Receipt</a>
