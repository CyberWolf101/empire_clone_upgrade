                            ...
                            <tbody>
                                <?php if (count($discounts) > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit-discount-modal">Edit Discount</button>
                                                <form action="" method="post" onsubmit="return confirm('Are you sure you want to delete this discount?')">
                                                    ...
                                                    <button class="btn btn-danger" type="submit" name="delete_discount">Delete Discount</button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php
