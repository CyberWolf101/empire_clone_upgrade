              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush text-primary">
                    ...
                    <tbody>
                        <?php
$sql = "SELECT * from academy_cart where id='$saloon' ORDER BY s ASC";
$sql2 = mysqli_query($con,$sql);
$i=1;
while ($row = mysqli_fetch_array($sql2)) {
...
?> 
                ...
                <br> 
               <center>
                  <?php if($stats =="processed"){?><p><form action='' method='get' onsubmit='return confirm("Are you sure you want mark this training as completed?");'>
