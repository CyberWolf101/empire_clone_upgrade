...
$themessage="";
$sql = "SELECT * from repair_failures where repair_id='$repairid'";
$sql2 = mysqli_query($con,$sql);
if (mysqli_affected_rows($con) == 0) {
$active_log = 0;
} else {
...
<p><img src='$siteimg' width='100px' height='100px' />
</p><br>
<p style='color:#FFFFFF;'>Message: 
<br><br>
<p style=' color:#fff;'>$info</p></p>
<p style=' color:#fff;'>Tracking id:$orid</p></p>
<br>
...
?>
		...
		<?php
	     ...
	     ?>
		  ...
		  <div style="margin-top:100px; color:#FFFFFF; padding:50px;">
		  <div class="justify-content-center" align="center"><p><span class="status">Status: <span style="font-weight:700;"><?php echo $status; ?></span></span>
		  <br></p></div>
    ...
    <?php
	  ...
	  ?>
       ...
       <p>Thank you for your service with us!</p>
         </p>
	    </div>
...
?>
	   ...
	   <br><br>
        ...
        <form id="form" name="form" action="" method="post" enctype="multipart/form-data" > 
                     ...
                     <input id="submit" name="message" class="btn btn-sm btn-primary shadow-sm w-100" type="submit" value="Send Message"></form>
	    </div>
...
<p><a href="index.php" class="btn btn-sm btn-primary shadow-sm w-100">BACK TO HOME</a></p>
<br> <br> 
	    </div>
