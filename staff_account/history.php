...
if(isset($_GET['categoryid'])){
    ...
    echo "<script>alert('Service Completed successfully!'); window.location.href = 'history.php';</script>";
...
?>
            ...
            <h1 class="h3 mb-0 text-gray-800">All Your Appointments</h1>
            <ol class="breadcrumb">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush text-primary">
                    ...
                    <tbody>
                        <?php
$sql = "SELECT * from appointments where staff='$id' AND status!='processing'  ORDER BY s ASC";
