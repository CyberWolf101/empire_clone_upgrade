...
?>
           ...
           <div class="col-lg-6 col-md-12">
               	<div class="row">
               	 <div class="col-lg-6 col-md-6 col-sm-6">
               	  ...
               	  <img src="http://chbluxuryempire.com/assets/img/luxury/logo_luxury.png" style="max-height: 60px;" alt="" class="img">CHB Luxury Ltd</div>
               	 </div>  
               	  <div class="col-lg-4 col-md-6 col-sm-6">
              <div style="color:white;" >	NGN  <?php echo $tot; ?> <br><?php echo $email; ?> <?php echo $first; ?></div>
               	 </div>  
   ...
   <div><span>  <?php echo $err; ?> </span>   <span>  <?php echo $err1; ?> </span>  <span>  <?php echo $alert; ?> </span>  </div>
