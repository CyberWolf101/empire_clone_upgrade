...
<h5 style="text-transform:uppercase;">CHBLUXURY ACADEMY </h5>
</div>
...
$sql = "SELECT * from training ORDER By name";
$sql2 = mysqli_query($con,$sql);
while($row = mysqli_fetch_array($sql2))
{$imageURL='../chbacademy/'.$row["picture"]; 
...
echo'
	...
	<td class="check" style="width:40%;" ><a href="detail.php?category='.$row['id'].'" class="submitn" style="float:right;">REGISTER NOW</a></td></tr>'
	;
	}
