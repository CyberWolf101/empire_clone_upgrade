...
if (isset($_GET['rowitem'])) {
   ...
   $del = mysqli_query($con, "DELETE from academy_cart where s='$item_delete'") or die('Could not connect: ' . mysqli_error($con));
      ...
      <div class="section-title" style="color:#FFFFFF;">
               ...
               <div class="col-md-12">
                  <table class="table table-bordered text-center" style="border-collapse: collapse;">
                     ...
                     <tbody>
                        ...
                        $sql = "SELECT * from academy_cart where id='$saloon' ";
                  ...
                  <table class="table" style="color: white; font-weight: 600;">
                     <tbody>
                        ...
                        <!-- <form method="post" action="https://checkout.flutterwave.com/v3/hosted/pay">
                           ...
                           <input type="hidden" name="customer[name]" style="border:0; color:#fff; width:300px;  outline:0; background:transparent; border-bottom:2px solid #fff;" value=" <?php echo  $username; ?> " />
               </div>
               <br> -->
       ...
       <div class="payment-methods p-3" style="background:#111; border:1px solid #FFC700; border-radius:10px;">
               ...
               <tr style="border-bottom-style: hidden;">
                  ...
                  // if ($total_all <= 0) {
                  //    echo '<td colspan="2" class="align-middle"><a href="index.php"  class="form-control" style="font-weight: 600; font-size: 0.8rem;  text-align:center; color: #FFC700;">
