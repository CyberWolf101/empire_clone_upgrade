...
$sql = "SELECT all* from delta_cart where id='$saloon' ";
...
{ echo '
                        ...
                        <td colspan="" class="text-right"><a href="soup.php" style="font-size: 0.8rem; color: rgb(209, 209, 209); font-weight: 600;" class="btn btn-secondary">Update Cart</a></td>
                        </tr>
                       </tfoot>                        
                       </table>
                       </div>
         ...
         $.ajax({
            ...
            success: function(response) {
               if (response === 'success') {
                  ...
                  window.location.href = 'https://chbluxuryempire.com/deltakitchen/success?status=completed&tx_ref=<?php echo $saloon; ?>';
   ...
   function updateValues() {
    ...
    $("html, body").animate({
      scrollTop: offsetTop
        ...
        <input type="hidden" name="redirect_url" value="https://chbluxuryempire.com/deltakitchen/success.php" />
        ...
        //Checkout Condition
                               ...
                               if($total_all <= 0){
                                echo'<td colspan="2" class="align-middle"><a href="index.php" class="form-control" style="font-weight: 600; font-size: 0.8rem; color: #FFC700;">
