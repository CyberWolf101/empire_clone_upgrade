...
<h5 style="text-transform:uppercase;">ALL CATEGORIES</h5>
</div>
...
$sql = "SELECT * from rental_subcategories ORDER By name";
$sql2 = mysqli_query($con,$sql);
while($row = mysqli_fetch_array($sql2))
{$imageURL='../gallery/'.$row["picture"]; 
...
echo'
	...
	<td class="check" style="width:40%;" ><a href="items.php?category='.$row['id'].'" class="submitn" style="float:right;">SELECT</a></td></tr>'
	;
	}
