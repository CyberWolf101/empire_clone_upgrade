    ...
    <section id="pricing" class="pricing section-bg" style="margin-top:50px; background-color:none;  border:none;">
      <div class="container" style="width:100%; margin:auto; ">
        <div class="section-title" style="color:#FFFFFF;">
          <h5 style="text-transform:uppercase;">SECTIONS - CHB LUXURY ACADEMY</h5>
        </div>
...
$sql = "SELECT all* from sub where gen='0012' ORDER By name ASC LIMIT 1000";
...
while($row = mysqli_fetch_array($sql2))
{
	...
	<input type="hidden" value="'.$orid.'" name="orig" /><button type="submit" name="submit" value="submit" class="submitn" style="float:right;">REGISTER</button></form></td></tr>'
	;
	}
