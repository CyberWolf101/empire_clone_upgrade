...
<tr class="ter mx-3" onclick=\'this.querySelector("input[type=radio]").click()\' >
	...
	?>
	 ...
	 <div class="btn-wrap">
<p style="color:black;" style="margin-bottom:30px;"> <form action="userdetails.php" method="post" >
 <input type="text" name="sub" value="<?php echo $orid;?>" hidden /><input type="submit" name="submit" value="Proceed to Payment" class="btn-buya"/> </form></p></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body w-100 text-center" style="background-color:#000000; color:#FFFFFF;">
		...
		<p><button class="submitn"  data-bs-dismiss="modal">Ok</button></p>
           <p style="color:black;" style="margin-bottom:30px;"> <form action="userdetails.php" method="post" >
         <input type="text" name="sub" value="<?php echo $orid;?>" hidden /><input type="submit" name="submit" value="Proceed to Payment" class="submitn"> </form></p>
