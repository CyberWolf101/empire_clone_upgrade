	       ...
	       <h6 style="text-transform:inherit; color:#FFFFFF;"><?php echo $des; ?></h6>
            <div class="box" data-aos="zoom-in" data-aos-delay="100" style="background:none;">
			 <div class="btn-wrap" style="text-align:center;">
               <form action="kitchen.php" method="post"><input type="hidden" value="<?php echo $orid; ?>" name="cate" />
			   <input type="hidden" value="<?php echo $ran; ?>" name="idea" />
			   <button type="submit" name="submit" value="submit" class="submitn">CLICK TO ORDER</button></form></div>
             
			   <div class="btn-wrap" style="text-align:center;">
               <p><a href="deltakitchen.php" class="submitn">BACK TO SECTIONS</a></p></div>
               </div>
               </div>
