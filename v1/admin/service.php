  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <h2>All Saloon and Spa Services</h2>
		...
		<?php 
		    ...
		    echo"<p style='color:blue;'>Service Successfully Deleted from Database!</staff>";	 
				}
...
JOIN cater ON sub.gen = cater.id AND cater.id != '0012' AND cater.id !='0017' AND cater.id !='0016' AND cater.id !='0015' ORDER by name ASC";
		...
		echo "
			...
			<td><input type='text' name='th' value='" . $row['time'] . "' required></td>	
...
WHERE cater.id != '0015' AND cater.id != '0016' AND cater.id != '0012' AND cater.id != '0017' AND baby.name LIKE '%".$sa."%' ORDER by name ASC"; 
$sql2 = mysqli_query($con,$sql);
