...
<html lang="en">
  ...
  width:300px;
		...
		<p> Submit customer details to proceed</p>
<div class="col-lg-4">
	<p><input type="text" class="form-control" name="name" placeholder="Your Name.." required/></p>
	<p><input type="email" class="form-control" name="mail" placeholder="Email.."  required/></p>
	<p><input type="number" class="form-control" name="mob" placeholder="Mobile Number.." ></p>
</div>
<div class="col-lg-12"> <p> <button type="submit" name="details" value="1" class="btn-buya">SUBMIT</button>  </p> </div>
