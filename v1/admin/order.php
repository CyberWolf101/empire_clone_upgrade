...
$pre=$per*$val;
 ...
 <div class="col-lg-12 col-md-8">
            ...
            <p><form action="" method="get"><input type="text" value="<?php echo $orid; ?>"  name="sub" hidden />
            <button class="submita" name="submitn" type="submit" value="pro">PROCEED TO PAYMENT</button></form></p>
