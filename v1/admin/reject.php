...
if (isset($_POST['cancel']))
 ...
 {
		    $use =  $_POST['repair_id'];
			$approve= mysqli_query($con,"update rental_center set confirmation='rejected' where rental_id='$use'") or die ('Could not connect: ' .mysqli_error($con)); 
...
while ($row = mysqli_fetch_array($sql4)) {
   $id=$row['rental_id'];
	...
	$email_to = $email;
    $email_subject = "Rental Request Dispproved!";
    $email_message ="
...
echo"<script>alert('Rental Disapproved!');
  ...
  <div class="vertical-alignment-helper">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body w-100 text-center" style="background-color:#000000; color:#FFFFFF;">
        <p style="font-weight:600;">Are you sure you want to reject this request?</p>
