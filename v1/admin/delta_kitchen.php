...
<?php 
			...
			$del = mysqli_query($con,"DELETE from sub where id='$use'") or die ('Could not connect: ' .mysqli_error($con)); 
	   	    echo"<p style='color:blue;'>Sub Category Successfully Deleted from Database!</staff>";	 
				}
					 ?>
<p style="text-align:center;"><a href="subs.php?kayd=1" class="submitn" >Add New Sub Category</a></p>
<p><div class="overflow-auto"><table class='table table-condensed table-hover table-striped' width='90%' border="0" cellspacing='10' data-toggle='bootgrid'><thead>
					...
					<th data-column-id='employee_salary'  width='200px'>Category Section</th>
		  ...
		  $sql = "SELECT * from sub where gen='0015' ";
...
<tr bgcolor='#fff'><td width='200px' >" . $row['name'] . "</td><td width='200px'>" . $keen. "</td>
