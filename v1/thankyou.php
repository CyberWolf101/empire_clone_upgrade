...
.btn-buya:hover {
  ...
  width:300px;
        ...
        <div class="col-lg-6">
        <p><b>THANK YOU!</b></p>
		<p>Thank you for choose CHB luxury repair center.
		We will get back to you in the next 24-72hrs if your device can be fixed or not.
		However this is your repair tracking code: <?php echo $id; ?> <a style='color:#FFC700;' href="http://chbluxuryempire.com/repair_progress.php?repairid=<?php echo $id; ?>"><u>click</u> </span>
