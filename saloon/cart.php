  ...
  <div class="vertical-alignment-helper">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body w-100 text-center" style="background-color:#000000; color:#FFFFFF;">
	   ...
	   <a href="foodpage.php" class="submitn">Yes,Proceed</a></p>
...
{ echo '
                        ...
                        <td colspan="2" class="text-right"><a href="category.php" style="font-size: 0.8rem; color: rgb(209, 209, 209); font-weight: 600;" class="btn btn-secondary">Update Cart</a></td>
                        </tr>
                       </tfoot>                        
                       </table>
                       </div>
   ...
   <div class="vertical-alignment-helper">
    ...
    <div class="modal-body w-100 text-center" style="background-color:#000000; color:#FFFFFF;">
    <p style="font-weight:600; font-size:13px;">Your booking type requires that you add more services else you can't checkout<br>i.e 2 or more services for couple booking or 3 or more services for family booking</p>
